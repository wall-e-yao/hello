...
public class QueryByName extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Friend> friends = model.Get_Friends_By_Query(username, friendname);
		request.setAttribute("friends", friends);
		request.setAttribute("byname", friendname);
		request.getRequestDispatcher("friendsInfo.jsp").forward(request, response);
		return ;
	}
